describe('Controller: MenuController', function(){
	...
	var MenuController, scope, $httpBackend;
	  ...
	  it('should create "dishes" with 2 dishes fetched from xhr', function() {
	  	...
	  	expect(scope.dishes.length).toBe(5);
	  });

	  it('should have the correct data order in dishes', function() {
	  	expect(scope.dishes[0].name).toBe("Uthapizza");
	  	expect(scope.dishes[1].label).toBe("New");
	  });

	  it('should chnge the tab selected based on tab clicked', function() {
